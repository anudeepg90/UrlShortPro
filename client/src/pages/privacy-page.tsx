          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                We collect information you provide directly to us, such as when you create an account, shorten URLs, or contact us for support.
              </p>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Personal Information:</h3>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>Email address (for account creation)</li>
                <li>Username (for account identification)</li>
                <li>URLs you shorten (to provide the service)</li>
                <li>Custom aliases you create</li>
              </ul>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Usage Information:</h3>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>Click tracking data for shortened URLs</li>
                <li>IP addresses of users clicking links</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                ...
                <li><strong>Public URLs:</strong> Shortened URLs and their destinations are publicly accessible</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-gray-700">
                  <strong>Email:</strong> privacy@tinyyourl.com<br />
                  <strong>Website:</strong> https://tinyyourl.com/contact<br />
                  <strong>Address:</strong> TinyYOUrl Privacy Team
                </p>
              </div>
            </section>
          </div>
